    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-20">
          {/* Who We Are */}
          <FadeInSection direction="left" className="rounded-3xl overflow-hidden shadow-xl">
            <div 
        ...
        <FadeInSection className="bg-black text-white rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6 mb-20">
          <div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-20">
          ...
          {/* Our Approach */}
          <FadeInSection direction="right" className="rounded-3xl text-white overflow-hidden">
            <div 
              className="p-12"
              style={{
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {/* Where We Work */}
          <FadeInSection direction="left" className="bg-black text-white rounded-3xl p-12">
            <h2 className="text-4xl font-bold mb-8 flex items-center gap-3">
              Where We Work
              <div className="h-1 w-12" style={{ backgroundColor: brandPurple }}></div>
            </h2>
          ...
          {/* Our Commitment */}
          <FadeInSection direction="right" className="bg-gradient-to-br from-gray-900 to-black text-white rounded-3xl p-12">
            <h2 className="text-4xl font-bold mb-8 flex items-center gap-3">
              Our Commitment
              <div className="h-1 w-12" style={{ backgroundColor: brandPurple }}></div>
            </h2>
